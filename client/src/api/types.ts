...
export interface Category {
  ...
  type: 'PERMANENT' | 'SEASONAL' | 'KIDS' | 'DRAWING' | 'STUDENT' | 'LIST';
...
export const LIFELINE_TYPES = ['PHONE_A_FRIEND', 'DOUBLE_ANSWER', 'MORE_HINT', 'TRAP', 'PICK_ANSWERER', 'STEAL_POINTS', 'DOUBLE_POINTS'] as const;
...
export const LIFELINE_LABELS: Record<LifelineType, { label: string; icon: string; desc: string }> = {
  ...
  DOUBLE_POINTS: { label: 'دبل النقاط', icon: '2️⃣', desc: 'ضاعف نقاط هذا السؤال لو جاوب فريقك صح' },
};
