...
async function main() {
  ...
  const categoryDefs: { name: string; icon: string; color: string; imageUrl?: string; type?: string; seasonTag?: string; questions: Q[] }[] = [
    ...
    },
    {
      ...
      questions: [
        { text: 'من هو البطل الخارق الذي يمتلك قوة خارقة ويطير، ويأتي أصلا من كوكب "كريبتون"؟', answer: 'سوبرمان', points: 100 },
        { text: 'ما اسم البطل الخارق الذي يرتدي درعا حديديا، وهو في الحقيقة رجل الأعمال توني ستارك؟', answer: 'آيرون مان', points: 100 },
        { text: 'من هو البطل الخارق الذي يحارب الجريمة ليلا في مدينة "جوثام" متنكرا بزي وطواط؟', answer: 'باتمان', points: 100 },
        { text: 'ما اسم البطلة الخارقة الأمازونية التي تحمل درعا وحبل الحقيقة؟', answer: 'واندر وومن', points: 100 },
        { text: 'من هو البطل الخارق الذي يمتلك قدرة نسج الشباك والتسلق على الجدران مثل العنكبوت؟', answer: 'الرجل العنكبوت (سبايدرمان)', points: 100 },
        { text: 'ما اسم فريق الأبطال الخارقين الذي يضم آيرون مان وكابتن أمريكا وثور وهالك؟', answer: 'المنتقمون (أفنجرز)', points: 100 },
        { text: 'من هو البطل الأخضر الضخم الذي تزداد قوته كلما غضب؟', answer: 'هالك', points: 100 },
        { text: 'ما اسم البطل الخارق الذي يحمل مطرقة تُدعى "مولنير" ويُعد إله الرعد؟', answer: 'ثور', points: 100 },
        { text: 'من هو البطل الخارق الذي يحمل درعا دائريا ويرتدي زيا بألوان العلم الأمريكي؟', answer: 'كابتن أمريكا', points: 100 },
        { text: 'ما اسم البطلة الخارقة القادمة من كوكب كريبتون أيضا، وهي ابنة عم سوبرمان؟', answer: 'سوبر غيرل', points: 100 },
        { text: 'من هو الشرير المعروف بضحكته المرعبة وشعره الأخضر، وهو ألد أعداء باتمان؟', answer: 'الجوكر', points: 100 },
        { text: 'ما اسم البطل الخارق السريع جدا لدرجة أنه يستطيع الجري عبر الزمن؟', answer: 'البرق (فلاش)', points: 100 },
        { text: 'من الممثل الذي جسّد شخصية آيرون مان في أفلام مارفل السينمائية؟', answer: 'روبرت داوني جونيور', points: 200 },
        { text: 'ما اسم المدينة الخيالية التي يعيش ويعمل فيها باتمان؟', answer: 'جوثام', points: 200 },
        { text: 'ما اسم كوكب سوبرمان الأصلي الذي دُمّر قبل وصوله إلى الأرض؟', answer: 'كريبتون', points: 200 },
        { text: 'من هو الشرير الرئيسي الذي يسعى لجمع "أحجار اللانهاية" في أفلام أفنجرز؟', answer: 'ثانوس', points: 200 },
        { text: 'ما اسم الجزيرة الخفية التي نشأت فيها واندر وومن؟', answer: 'ثيميسكيرا', points: 200 },
        { text: 'من هي الصحفية التي تُعد الحب الأول لسوبرمان (كلارك كينت)؟', answer: 'لويس لين', points: 200 },
        { text: 'ما هو الاسم الحقيقي لباتمان؟', answer: 'بروس واين', points: 200 },
        { text: 'ما اسم الشركة التي أنشأت شخصيات مثل باتمان وسوبرمان وواندر وومن؟', answer: 'دي سي كومكس', points: 200 },
        { text: 'من هو الطالب الذي أصبح الرجل العنكبوت بعد أن لدغته عنكبوت مشع؟', answer: 'بيتر باركر', points: 200 },
        { text: 'ما اسم الشرير الذي يُعد ألد أعداء الرجل العنكبوت ويرتدي زيا أخضر يشبه الشيطان؟', answer: 'الغرين غوبلن', points: 200 },
        { text: 'من الكاتب الذي شارك في ابتكار شخصيات مثل الرجل العنكبوت والرجال إكس، وأصبح رمزا لشركة مارفل؟', answer: 'ستان لي', points: 200 },
        { text: 'ما اسم فريق الأبطال الخارقين من المتحولين المرتبط بجامعة يديرها البروفيسور إكس؟', answer: 'الرجال إكس', points: 200 },
        { text: 'من الممثل الذي جسّد شخصية الجوكر وفاز بجائزة الأوسكار عن هذا الدور عام 2020؟', answer: 'واكين فينيكس', points: 300 },
        { text: 'ما اسم فيلم مارفل الذي جمع معظم أبطال أفنجرز لأول مرة لمحاربة ثانوس، وصدر عام 2018؟', answer: 'أفنجرز: حرب اللانهاية', points: 300 },
        { text: 'من الممثل الذي جسّد شخصية باتمان في ثلاثية المخرج كريستوفر نولان؟', answer: 'كريستيان بيل', points: 300 },
        { text: 'ما اسم الموطن الأصلي للشرير ثانوس قبل بحثه عن أحجار اللانهاية؟', answer: 'تيتان', points: 300 },
        { text: 'من الكاتب الذي شارك في ابتكار شخصية سوبرمان إلى جانب الرسام جو شوستر؟', answer: 'جيري سيغل', points: 300 },
        { text: 'من المخرج الذي أخرج فيلم "الجوكر" الحائز على جوائز عام 2019؟', answer: 'تود فيليبس', points: 300 },
        { text: 'من الممثلة التي جسّدت شخصية واندر وومن في الأفلام الحديثة؟', answer: 'غال غادوت', points: 300 },
        { text: 'ما اسم المعدن النادر الذي يُصنع منه درع النمر الأسود ويوجد بكثرة في موطنه؟', answer: 'الفيبرانيوم', points: 300 },
        { text: 'من هو الشرير الذي يُعد الأخ بالتبني لثور ويسعى للسيطرة على أسغارد؟', answer: 'لوكي', points: 300 },
        { text: 'ما اسم الجامعة التي يدير فيها البروفيسور إكس مدرسته للمتحولين الموهوبين؟', answer: 'جامعة إكسفير للموهوبين', points: 300 },
        { text: 'من الممثل الذي يجسد شخصية سبايدرمان (بيتر باركر) في أحدث سلسلة أفلام مارفل السينمائية منذ 2017؟', answer: 'توم هولاند', points: 300 },
        { text: 'ما اسم الدولة الأفريقية الخيالية الغنية بمعدن الفيبرانيوم وموطن النمر الأسود؟', answer: 'واكاندا', points: 300 },
      ],
    },
  ];
